...
\textbf{Codalab Username:} Enter your username here \\ 
\textbf{Final Leaderboard Rank on the Test Set:} Enter your rank \\ 
\textbf{chrF++ Score corresponding to the Final Rank:} Enter the score \\ 
\textbf{ROUGE Score corresponding to the Final Rank:} Enter the score \\ 
\textbf{BLEU Score corresponding to the Final Rank:} Enter the score \\ 
\textbf{Total Number of Submissions in the Training Phase:} Enter the number of submissions \\ 
\textbf{Total Number of Submissions in the Testing Phase:} Enter the number of submissions \\ 
\textbf{Table showing the Number of Submissions made each Week during the Training Phase:} \\
...
\begin{enumerate}
\item Results of different models on dev data in tabular format. If you didn't take part in the training phase, leave it blank. \item In the results table show all metrics, as provided in the evaluation scripts. You can also have a column for rank on the leaderboard if you like. 
